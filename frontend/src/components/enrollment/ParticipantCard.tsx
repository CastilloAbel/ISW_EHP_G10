...
export const ParticipantCard = memo(
  ...
  (prevProps, nextProps) => {
    ...
    return (
      ...
      prevProps.participante.nombre === nextProps.participante.nombre &&
      prevProps.participante.dni === nextProps.participante.dni &&
      prevProps.participante.edad === nextProps.participante.edad &&
      prevProps.participante.talla === nextProps.participante.talla &&
      prevProps.requiereTalle === nextProps.requiereTalle
    );
  },
);
